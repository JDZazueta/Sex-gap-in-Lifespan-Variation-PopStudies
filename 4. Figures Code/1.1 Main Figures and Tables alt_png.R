...
Fig_1
ggsave(filename = "Figure 1.png", path= "Main Figures and Tables/",
...
Fig_2 <- ggplot(Data_figure_2, mapping = aes(x=Contribution,
  ...
  labs(title = "",
       ...
       x= "Absolute contribution (years) to the sex gap")
Fig_2
ggsave(filename = "Figure 2.png", path= "Main Figures and Tables/",
       dpi = 500, width = 12.5, height = 10.5,
       bg = "white")
...
Fig_3 <- ggplot(data=Data_figure_3,
  ...
  labs(#title = bquote(~'Change in Sex gap in '~ e[0] ~'2000-2015, Europe' ),
    ...
    x="Age groups")
#Fig_3
#ggsave(filename = "Figure 3.png", path= "Main Figures and Tables/",
...
table(Data_fig_3_Europe$Cause2)



fig_3_Europe <- ggplot(data=Data_fig_3_Europe,
                       aes(x=Age2, y=Contribution2, 
                           fill=Cause2, pattern=Cause2)) +
  #geom_bar(stat = "identity", position = "stack") +
  #geom_bar_pattern(
  #  aes(pattern_fill = Cause2, pattern = Cause2),
  #  stat = "identity", position = "stack",
  #  colour          = 'black') +
  ...
  #scale_fill_brewer(palette = "RdGy") +
  #scale_pattern_fill2_grey() +
  scale_pattern_fill_manual(values = Pattern_cause) +
  scale_fill_manual(values = CoD_Decomp.blackwhite) +
...
ggsave(filename = "Figure 4.png", path= "Main Figures and Tables/",
       dpi = 500, width = 12.5, height = 10.5,
       bg = "white")
...
Fig_5
ggsave(filename = "Figure 5.png", path= "Main Figures and Tables/",
       dpi = 500, width = 12.5, height = 10.5,
       bg = "white")
...
Fig_6 <- ggplot(Data_figure_6_wider, mapping = aes(x=SGLE,
  ...
  labs(title = "",
       ...
       y=bquote(~'Relative contribution (%) to the sex gap in '~ SD ~ ""))
Fig_6
ggsave(filename = "Figure 6.png", path= "Main Figures and Tables/",
       dpi = 500, width = 12.5, height = 10.5,
       bg = "white")
